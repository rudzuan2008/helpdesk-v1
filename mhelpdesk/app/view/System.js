Ext.define('mhelpdesk.view.System', {
	...
	config : {
		...
		urlPostPicture : "http://android.schoolcheck-now.com/helpdesk/remote/getfile.php", //"http://localhost/sc-now-android/remote/getfile.php", //
		urlPicturePath : "http://android.schoolcheck-now.com/helpdesk/", //"http://localhost/sc-now/", //
		build: null,
		deviceOS: null,
		cameraOff: false,
		screenMode: 0,
	...
	getDefaultServer: function() {
		return 'http://android.schoolcheck-now.com/helpdesk/'; //  "http://localhost/sc-now/"; //
	},
